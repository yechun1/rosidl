...
//   Only allowed on modules, structs, members, enums and enum identifiers
...
floating_pt_literal: DIGIT+ "." DIGIT+ "e"i DIGIT*
  | "." DIGIT+ ("e"i DIGIT*)?
  | DIGIT+ "." ("e"i DIGIT*)?
  | DIGIT+ "e"i DIGIT*
